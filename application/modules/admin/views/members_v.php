									...
									<?php if(!empty($membership_lists)){ ?>
										...
										<?php foreach ($membership_lists as $membership_list) { ?>
											<tr>
												...
												<td><?php echo $membership_list->name; ?></td>
												<td><?php echo returnValue('memberships','title','membership_id',$membership_list->membership_id); ?></td>
												<td><?php echo $membership_list->download_limits; ?></td>
												<td><?php echo $membership_list->downloaded; ?></td>
												<td><?php echo dateFormat('m-d-Y',$membership_list->expiry_date); ?></td>
