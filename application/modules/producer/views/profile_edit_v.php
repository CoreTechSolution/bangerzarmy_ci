                    ...
                    <div class="box-wrapper">
                        ...
                        <div class="box-container">
				            ...
				            <?php echo form_open_multipart(base_url($method.'/'.$users->user_id), array('class'=>'form')); ?>
                                ...
                                <div class="form-group">
                                    <label for="profile_img">Bio:</label>
                                    <textarea id="bio" name="bio" class="form-control textarea-no-styles" rows="10"><?php echo !empty($users->bio)?$users->bio:''; ?></textarea>
                                </div>
							    
							    <button type="submit" name="submit" value="submit" class="btn btn-red">Update</button>
							    <a href="<?php echo base_url('producer/dashboard'); ?>" class="btn btn-red">Cancel</a>
