<div class="logged-in-usermenus">
    <ul>
        ...
        <li><a href="<?php echo base_url($this->session->userdata('user_type')); ?>/profile_edit/<?php echo $this->session->userdata('user_id'); ?>"><i class="fa fa-thumb-tack fa-fw" aria-hidden="true"></i>Profile</a></li>
